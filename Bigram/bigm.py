...
#---------------------------------Prediction Starts Here-------------------------------------------------------        
    ...
    for each_review in test_handler:
        ...
        prob_pos_given_review = predict_positive(words_in_review, positive_unigram_vocab, positive_bigram_vocab, negative_unigram_vocab, negative_bigram_vocab, vocab_count)
        prob_neg_given_review = predict_negative(words_in_review, positive_unigram_vocab, positive_bigram_vocab, negative_unigram_vocab, negative_bigram_vocab, vocab_count)
        REVIEW = 0
...
def predict_positive(words_in_review, positive_unigram_vocab, positive_bigram_vocab, negative_unigram_vocab, negative_bigram_vocab, vocab_count):
    
    prob_pos = math.log2(float(positive_unigram_vocab["+"])/(float(positive_unigram_vocab["+"]) + float(negative_unigram_vocab["-"])))  
...
def predict_negative(words_in_review, positive_unigram_vocab, positive_bigram_vocab, negative_unigram_vocab, negative_bigram_vocab, vocab_count):
    
    prob_neg = math.log2(float(negative_unigram_vocab["-"])/(float(positive_unigram_vocab["+"]) + float(negative_unigram_vocab["-"])))  
